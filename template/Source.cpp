 ...
 * while loop prints up to 50 can be reduced or expanded to include more lines
 ************************************************************/
void writeList(ListNode* ptr)
{
 ...
 *                     displayPartialList
 * Function description
 * shows the newly updated list in the console terminal before being changed by deleteNode
 * so if c is the input states starting with letter c will be placed at the top of the list
